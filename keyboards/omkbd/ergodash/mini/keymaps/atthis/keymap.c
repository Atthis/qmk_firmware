...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+Enter/+------+------+------+Space/+------+------+------+------+-------------|
   * |      |  `   |CPSLCK|||||||| GUI  | LAlt | LT 1 |  \   ||||||||      | LT 2 | Ralt |||||||| Left |  Up  | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(
    ...
    KC_NO,    KC_GRV,   KC_CAPS,          LT(4,KC_LGUI),  KC_LALT,  LT(1,KC_ENT), KC_BSLS,      KC_RALT,  KC_SPC,       MO(2),              KC_LEFT,  KC_UP,  KC_DOWN,  KC_RGHT
  ),
  ...
  [_NUMPAD] = LAYOUT(
    ...
    KC_LSFT,  KC_NO,    MS_WHLU,  MS_BTN1,MS_BTN2,    MEH(KC_PGUP), KC_PGDN,                              KC_BSPC,      KC_HOME,  KC_NO,    KC_P4,    KC_P5,  KC_P6,    KC_PAST,
    KC_LCTL,  KC_NO,    MS_WHLD,  KC_NO,  KC_NO,      MEH(KC_PGDN),               KC_NO,        KC_PSCR,                KC_END,   KC_NO,    KC_P1,    KC_P2,  KC_P3,    KC_PMNS,
    KC_NO,    KC_NO,    TG(1),            KC_NO,      KC_NO,        KC_TRNS,      KC_NO,        KC_NO,    KC_SPC,       MO(3),            KC_P0,    KC_PDOT,KC_PENT,  KC_PPLS
  ),

  /* Number
  */
  [_NUMBER] = LAYOUT(
    KC_EXLM, KC_AT,     KC_HASH,  KC_DLR, KC_PERC,    KC_CIRC,      MS_WHLU,                              KC_ESC,       KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,KC_UNDS,  KC_PLUS,
    KC_1,    KC_2,      KC_3,     KC_4,   KC_5,       KC_6,         MS_WHLD,                              KC_BSPC,      KC_7,     KC_8,     KC_9,     KC_0,   KC_MINS,  KC_EQL,
    KC_NO,   KC_NO,     KC_NO,    KC_NO,  KC_NO,      KC_NO,                      KC_NO,        KC_NO,                  KC_NO,    KC_NO,    KC_NO,    KC_NO,  KC_NO,    KC_NO,
    KC_NO,   KC_NO,     TG(1),            KC_NO,      KC_NO,        LT(3,KC_ENT), KC_NO,        KC_NO,    KC_NO,        KC_TRNS,            KC_NO,    KC_NO,  KC_NO,    KC_NO
  ),
  ...
  */
  [_MEDIA_] = LAYOUT(
    ...
    KC_NO,   KC_NO,     KC_NO,    KC_NO,  KC_NO,      KC_NO,                      KC_NO,        KC_NO,                  KC_NO,    KC_NO,    KC_NO,    KC_NO,  KC_NO,    KC_NO,
    KC_NO,   KC_NO,     KC_NO,            KC_NO,      KC_NO,        KC_TRNS,      KC_NO,        KC_NO,    KC_NO,        KC_TRNS,            KC_NO,    KC_NO,  KC_NO,    KC_NO
  ),
